...
bucket_name_str = subprocess.getoutput('aws s3api list-buckets --query "Buckets[].Name" | grep s3site | tr -d "," | xargs')

client = boto3.client('apigateway', region_name='us-east-1')
client_bucket = boto3.client('s3', region_name='us-east-1')
...
options_integration_response = client.put_integration_response(
    ...
    responseParameters={
        ...
        'method.response.header.Access-Control-Allow-Origin': "'https://" + bucket_name_str + ".s3-us-east-1.amazonaws.com'",
        'method.response.header.Access-Control-Allow-Credentials': "'true'"
